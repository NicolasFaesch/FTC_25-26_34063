...
public class AutoConfig {
    ...
    @Sorter(sort=1)
    public static AutoManagement.Objective SECOND_OBJECTIVE = AutoManagement.Objective.SPIKE_MARK_CLOSE;
    @Sorter(sort=2)
    public static AutoManagement.Objective THIRD_OBJECTIVE = AutoManagement.Objective.SHOOT;
    @Sorter(sort=3)
    public static AutoManagement.Objective FOURTH_OBJECTIVE = AutoManagement.Objective.SPIKE_MARK_MIDDLE;
    @Sorter(sort=4)
