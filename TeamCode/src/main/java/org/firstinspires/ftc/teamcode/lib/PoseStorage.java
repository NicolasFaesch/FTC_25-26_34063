...
public class PoseStorage {
    ...
    public static final Pose2D parkingPoseRED = new Pose2D(DistanceUnit.METER, 0,0,AngleUnit.DEGREES,0); //Todo
    public static final Pose2D parkingPoseBLUE = new Pose2D(DistanceUnit.METER,0,0,AngleUnit.DEGREES,0); //Todo
